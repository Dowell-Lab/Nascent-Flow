...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Merge Count\n\n===============================================================================================================\n\nA short and simple python script to merge count files generated from multicov.', epilog='@Dowell Lab, Margaret Gruca', usage='%(prog)s --beds /my/sample/dir/*.bed --output /my/out/file.bed', formatter_class=RawTextHelpFormatter)
